...
public class ExplicitLocksWithInterruption {
	...
	public static void main(String[] args) {
		...
		explicitLocksWithInterruption
				.add(explicitLocksWithInterruption.createWeblink(2002, "Interface vs Abstract Class",
						"http://mindprod.com/jgloss/interfacevsabstract.html", "http://mindprod.com"));
		explicitLocksWithInterruption.add(explicitLocksWithInterruption.createWeblink(2003,
				"Virtual Hosting and Tomcat", "http://tomcat.apache.org/tomcat-6.0-doc/virtual-hosting-howto.html",
