...
public class GenericsDemo1<T> {
	...
	<E extends T> GenericsDemo1(E object) {
	}
	// <E> GenericsDemo1(E object) {}
	// GenericsDemo1(T object) { }
	// <E extends T> GenericsDemo1() {}
	...
	static void genericMethodsDemo() {
		...
		// Java 7)
		GenericsDemo1.targetTypeInvoker1(typeArgInferenceFromTargetType2()); // Eclipse Mars showing incorrect type arg
		GenericsDemo1.targetTypeInvoker1(new ArrayList<>()); // Eclipse Mars showing incorrect type arg
		GenericsDemo1.targetTypeInvoker2(typeArgInferenceFromTargetType2()); // Infers as Object
		List<String> strList = GenericsDemo1.targetTypeInvoker2(typeArgInferenceFromTargetType2());
		GenericsDemo1.targetTypeInvoker2(new ArrayList<>());
		List<String> strList2 = GenericsDemo1.targetTypeInvoker2(new ArrayList<>());
		...
		GenericsDemo1.<String>uselessGenericMethod(); // type witness

		// Explicit Type Argument Specification: Type witness. Comment out Generic
		// constructor!!
		// GenericsDemo1.<GenericsDemo1>typeArgInference(new GenericsDemo1());
		...
		new GenericsDemo1<Number>(12.0); // T is Number, E is Double
		new GenericsDemo1<>(12.0); // T & E are Double
		new <Double>GenericsDemo1<Number>(12.0); // Type witness!!
		// new <Double>GenericsDemo1<>(12.0); // Could have inferred from arg
		GenericsDemo1<Number> gd = new GenericsDemo1<>(12.0); // To avoid invariance, smartly infers Number for <>
																// rather
																// than Double
